...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="//commandBarData[@guid='7c905e2a-cb64-4ba1-aff0-c306f392680c']/toolbar">
    <xsl:apply-templates mode="insert-item" select=".">
      <xsl:with-param name="content">
        <xsl:if test="not(./item[@guidRef='181dbca6-2c75-4b0b-8af2-dc3eb08a97d2'])">
          <!-- Only insert if its not already there -->
          <item guidRef="181dbca6-2c75-4b0b-8af2-dc3eb08a97d2"/>
        </xsl:if>
      </xsl:with-param>
    </xsl:apply-templates>
  </xsl:template>
  ...
  <xsl:template match="uiConfig/commandBars/commandBarData[@guid='74e03d83-404c-49f5-824a-fe0fd02ab29a']/toolbar">
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
      <modeData guid="dd680f8d-ef7d-4062-b778-ed1ae2e585e4" captionRef="01965a34-ae38-01a0-4271-cd903b48e518">
